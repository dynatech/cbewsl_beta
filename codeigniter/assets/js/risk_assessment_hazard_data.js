...
function getAllHazardData() {
    $.ajax({
        url: "http://192.168.8.101:5000/api/hazard_data/get_all_hazard_data",
...
function getAllHazardMapData() {
    $.ajax({
        url: "http://192.168.8.101:5000/api/hazard_data/get_all_hazard_map_data",
        beforeSend: function (xhr) {
            xhr.overrideMimeType("text/plain; charset=x-user-defined");
        }
    }).done(function (data) {
...
function saveHazardData() {
    $("#add_hazard_data").click(function () {
        let url = "http://192.168.8.101:5000/api/hazard_data/save_hazard_data";
        let data = {
...
function deleteHazardData(hazard_data_id) {
    let url = "http://192.168.8.101:5000/api/hazard_data/delete_hazard_data";
    let data = {
