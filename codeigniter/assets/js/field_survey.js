...
function getAllFieldSurvey() {
    $.ajax({
        url: "http://192.168.8.100:5000/api/field_survey/get_all_field_survey",
...
function deleteFieldSurvey(field_survey_id) {
    let url = "http://192.168.8.100:5000/api/field_survey/delete_field_survey";
    let data = {
        "field_survey_id": field_survey_id
    }
...
function sendFieldSurveyViaEmail(date) {
    ...
    $("#confirm_send_field_survey").click(function () {
        let url = "http://192.168.8.100:5000/api/field_survey/send_email";
        let data = {
            date: date,
...
function fieldSurveyButtonAction() {
    $("#add_field_survey").click(function () {
        let url = "http://192.168.8.100:5000/api/field_survey/save_field_survey";
        let data = {
