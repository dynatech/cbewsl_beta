...
function saveRNC() {
    $("#add_resources_capacity").click(function () {
        let url = "http://192.168.150.191:5000/api/resources_and_capacities/save_resources_and_capacities";
        let data = {
...
function deleteRNC(resources_and_capacities_id) {
    let url = "http://192.168.150.191:5000/api/resources_and_capacities/delete_resources_and_capacities";
    let data = {
