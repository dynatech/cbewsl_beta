...
function initializeSurficialData() {
    $('#surficial-data-tab').on('click', function () {
        ...
        fetch('http://192.168.8.100:5000/api/surficial_data/get_surficial_data').then((response) => response.json())
            .then((responseJson) => {
...
function initializeCurrentMeasurement() {
    $("#current_measurement_tab").on('click', function () {
        ...
        $('.measurements').empty();
        fetch('http://192.168.8.100:5000/api/surficial_data/get_current_measurement').then((response) => response.json())
            .then((responseJson) => {
...
function initializeMonitoringLogs() {
    let formatted_data = []
    fetch('http://192.168.8.100:5000/api/surficial_data/get_moms_data').then((response) => response.json())
        .then((responseJson) => {
...
function deleteMonitoringLogs(moms_id) {
    let url = "http://192.168.8.100:5000/api/moms_data/delete_moms_data";
    let data = {
        "moms_id": moms_id
    }
...
function initializeCRUDMonitoringLogs() {
    $('#add_monitoring_logs').on('click', function () {
        let url = "http://192.168.8.100:5000/api/surficial_data/save_monitoring_log";
        let data = {
            moms_id: $("#moms_id").val(),
...
function displayRaiseMomsModal(data) {
    ...
    $('#raise_moms').on('click', function () {
        ...
        isOnSet(alert_level)
            .then((response) => {
                let url = 'http://192.168.8.100:5000/api/monitoring/insert_cbewsl_moms';
                fetch(url, {
                    method: 'POST',
                    dataType: 'jsonp',
                    headers: {
