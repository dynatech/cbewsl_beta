...
function initializeMaintenanceLogsCalendar() {
    ...
    $.ajax({
        url: "http://192.168.8.100:5000/api/sensor_maintenance/get_all_sensor_maintenance",
...
function saveMaintenanceLogs() {
    $("#add_maintenance_logs").click(function () {
        let url = "http://192.168.8.100:5000/api/sensor_maintenance/save_sensor_maintenance_logs";
...
function maintenanceLogsDataAction() {
    ...
    $("#delete_maintenance_log").click(function () {
        if (confirm('Are you sure you want to delete this entry?')) {
            let url = "http://192.168.8.100:5000/api/sensor_maintenance/delete_sensor_maintenance";
            let data = {
                "sensor_maintenance_id": $("#sensor_maintenance_id").val()
            }
...
function initalizeSensorMaintenanceData() {
    $.ajax({
        url: "http://192.168.8.100:5000/api/rainfall/get_rainfall_plot_data/umi",
        beforeSend: function (xhr) {
            xhr.overrideMimeType("text/plain; charset=x-user-defined");
