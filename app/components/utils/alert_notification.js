...
const Notification = {
    endOfValidity: async function () {
        ...
        offline_data.then(response => {
            if (response == null || response == undefined) {
                // fetch('http://192.168.8.100:5000/api/monitoring/get_latest_cbewls_release/50').then((response) => response.json())
                //     .then((responseJson) => {
    ...
    fetchCandidateAlert: async function () {
        ...
        offline_data.then(offline_response => {
            if (offline_response != null || offline_response != undefined) {
                fetch('http://192.168.8.100:5000/api/monitoring/get_candidate_and_current_alerts').then((response) => response.json())
                    .then((online_data) => {
    ...
    validateAlert: async function (trigger_id, valid, remarks, user_id, candidate_alerts, flag = false) {
        fetch('http://192.168.8.100:5000/api/monitoring/update_alert_status', {
            method: 'POST',
            dataType: 'jsonp',
            headers: {
        ...
        fetch('http://192.168.8.100:5000/api/monitoring/update_alert_gen/false').then((response) => response.json())
            .then((online_data) => {
