...
const Sync = {
    serverToClient: async function (storage_key = "") {
        const DOCROOT = 'http://192.168.1.101:5000'
        let KEYS_N_API = [
    ...
    clientToServer: async function (storage_key) {
        const API_LIST = {
            "RiskAssessmentSummary": "http://192.168.1.101:5000/api/risk_assesment_summary/save_risk_assessment_summary",
            "RiskAssessmentFamilyRiskProfile": "http://192.168.1.101:5000/api/family_profile/save_family_profile",
            "RiskAssessmentHazardData": "http://192.168.1.101:5000/api/hazard_data/save_hazard_data",
            "RiskAssessmentRNC": "http://192.168.1.101:5000/api/resources_and_capacities/save_resources_and_capacities",
            "FieldSurveyLogs": "http://192.168.1.101:5000/api/field_survey/save_field_survey",
            "SurficialDataMeasurements": "6",
            "SurficialDataMomsSummary": "http://192.168.1.101:5000/api/surficial_data/save_monitoring_log",
            "SensorMaintenanceLogs": "http://192.168.1.101:5000/api/sensor_maintenance/save_sensor_maintenance_logs",
            "Pub&CandidAlert": "9",
            "SituationReportLogs": "http://192.168.1.101:5000/api/situation_report/save_situation_report"
        }
