...
export default class ModifyFamilyRisk extends Component {
  ...
  removeLog(id) {
    ...
    fetch('http://192.168.1.101:5000/api/family_profile/delete_family_profile', {
      method: 'POST',
      headers: {
  ...
  getAllFamilyProfile() {
    Notification.endOfValidity();
    fetch('http://192.168.1.101:5000/api/family_profile/get_all_family_profile').then((response) => response.json())
      .then((responseJson) => {
