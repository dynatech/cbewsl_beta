      ...
      .then((responseJson) => {
        ...
        for (const [index, value] of responseJson.entries()) {
          summary_data.push(<DataTable.Row style={{ width: 500 }}>
            ...
            <DataTable.Cell>
              <Icon name="md-add-circle-outline" style={{ color: "blue" }} onPress={() => this.updateLog(value)}></Icon>
              <Icon name="md-remove-circle-outline" style={{ color: "red" }} onPress={() => this.removeLog(value)}></Icon>
            </DataTable.Cell>
          </DataTable.Row>)
        }
